function [output] = hierarchical_clustering_laboratory_frame(linkage_method)
% Hierarchical Clustering results for laboratory frame
...
for k=1:100
    for j = 1:3 % three compared scenarios
        ...
        for i=1:4   % sensors
            ...
            load("/MATLAB Drive/features_sensor"+int2str(i)+"_d0.mat") % reference
            X_train = features_data(1:100,:);
            load("/MATLAB Drive/features_sensor"+int2str(i)+"_"+scenario(j)+".mat") % compared scenario
